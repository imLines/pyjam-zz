...
import SortBarAngelNightie from "../../partials/sortbar/SortBarAngelNightie";


function AngelNightie() {
        ...
        return (
            <>
                <section className="flex flex-col items-center bg-p-light min-h-screen pt-5">
                    <h1 className="text-2xl font-[900] mb-16 flex"><img className="w-8 h-8" src={angelIcon} alt="angel icon" />Nuisettes<img className="w-8 h-8" src={angelIcon} alt="angel icon" /></h1>
