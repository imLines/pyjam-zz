...
function PyjamasSexy(){
    ...
    return(
        <section className="flex flex-col items-center bg-p-light min-h-screen pt-24">
                <h1 className="text-2xl font-[900] mb-16 flex"><img className="w-8 h-8" src={demonIcon} alt="demon icon" />Pyjamas Ange<img className="w-8 h-8" src={demonIcon} alt="demon icon" /></h1>
                <div className=" flex flex-row flex-wrap justify-center items-center w-full mx-auto md:flex-row md:flex-wrap md:justify-center">
                    {allProducts?.map(item=><DemonCard item={item} key={item.id} />)}
                </div>
